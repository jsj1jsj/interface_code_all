...
class Request1(unittest.TestCase):
    ...
    def test_002(self):  # 查询结果
        ...
        self.driver.find_element_by_xpath('//*[@id="submit"]/i').click()
        time.sleep(TIME_MANAGER.TIME_INQUIRE_REPORT_DELAY_SEC_002)
    ...
    def test_005(self):
        ...
        self.driver.switch_to.frame(frame1)
        time.sleep(TIME_MANAGER.TIME_INQUIRE_REPORT_DELAY_SEC)
        self.driver.find_element_by_xpath( '//*[@id="seq"]' ).send_keys(temp[IndexSet.aIndex]['查询疑似风险交易5'])
        ...
        if flag:
            ...
            temp[IndexSet.aIndex]['实际结果5'] = self.driver.find_element_by_xpath('//*[@id="msgResult"]/tbody/tr/td[7]').text
